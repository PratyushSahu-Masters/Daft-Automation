...
public class Common extends AbstractPage {
	...
	public WebElement waitUntilElementTextChanged(String xpath) {
		WebElement dynamicTextElement = driver.findElement(By.xpath(xpath));
		String beforeText = dynamicTextElement.getText();
		getWait().until(ExpectedConditions.not(ExpectedConditions.textToBe(By.xpath(xpath), beforeText)));
